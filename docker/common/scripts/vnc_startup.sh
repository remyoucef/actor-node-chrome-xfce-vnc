...
echo "
USAGE:
docker run -it -p 6901:6901 -p 5901:5901 remyoucef/actor-node-chrome-xfce-vnc:<tag> <option>
...
Fore more information see: https://github.com/remyoucef/actor-node-chrome-xfce-vnc
"
}
if [[ $1 =~ -h|--help ]]; then
    help
